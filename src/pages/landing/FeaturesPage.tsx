...
const features = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        description:
          "Get instant updates and notifications across all your devices.",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description:
          "Advanced data protection and privacy controls for your information.",
    ...
    items: [
      {
        ...
        description:
          "Get detailed insights and analytics to grow your business.",
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-xl text-muted-foreground mb-8">
                Join thousands of businesses that trust SaaSify for their daily
                operations.
              </p>
