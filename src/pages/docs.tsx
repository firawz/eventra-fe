            ...
            <div className="text-center max-w-3xl mx-auto">
              ...
              >
                ...
                <p className="text-xl text-muted-foreground mb-8">
                  Comprehensive guides and documentation to help you get the
                  most out of SaaSify.
                </p>
              ...
              <div className="grid md:grid-cols-4 gap-8">
                ...
                <div className="md:col-span-3">
                  <div className="prose prose-lg dark:prose-invert max-w-none">
                    ...
                    <p>
                      Welcome to SaaSify! This guide will help you get up and
                      running with our platform. We'll cover everything from
                      installation to advanced features.
                    </p>

                    <h3>Installation</h3>
                    <p>To get started with SaaSify, you'll need to:</p>
                    <ol>
                    ...
                    <h3>Quick Start</h3>
                    <p>Here's a quick overview of the main features:</p>
                    <ul>
                    ...
                    <div className="bg-muted p-4 rounded-lg my-6">
                      ...
                      <p className="mb-0">
                        Use our API to automate common tasks and integrate with
                        your existing tools.
                      </p>
                    </div>
                    ...
                    <h3>Next Steps</h3>
                    <p>
                      Once you're familiar with the basics, check out our
                      advanced guides for:
                    </p>
                    <ul>
